...
const SvgVisualStudioCodeLogo = (props) => (
  <svg
  ...
  >
    <defs>
      <path
        id="Visual_Studio_Code_logo_svg__a"
    ...
    <mask id="Visual_Studio_Code_logo_svg__b" fill="#fff">
      <use xlinkHref="#Visual_Studio_Code_logo_svg__a" />
    </mask>
    <path
      fill="#0065A9"
      ...
      mask="url(#Visual_Studio_Code_logo_svg__b)"
    />
    <path
      fill="#007ACC"
    ...
    />
    <path
      fill="url(#Visual_Studio_Code_logo_svg__c)"
      fillOpacity={0.25}
...
export default SvgVisualStudioCodeLogo;
